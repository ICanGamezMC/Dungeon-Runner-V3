...
scoreboard players set NUMBER error 0
execute unless function admin:errors/base_dungeon run scoreboard players set NUMBER error 1
execute unless score NUMBER error matches 1 run tellraw @a ["",{"text":"ERROR 003","bold":true,"color":"red"},{"text":" : BASE DUNGEON TESTING ERROR  ","bold":true,"color":"red"},{"text":" { Check File for corruption }","bold":true,"color":"dark_red"}]
