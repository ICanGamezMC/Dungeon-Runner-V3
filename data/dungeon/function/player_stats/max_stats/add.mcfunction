...
execute as @s run scoreboard players set @s MaxHealthADD 0
execute as @s run scoreboard players set @s MaxDefenseADD 0
execute as @s run scoreboard players set @s MaxManaADD 0
execute as @s run scoreboard players set @s Health_RegenADD 0
execute as @s run scoreboard players set @s Mana_RegenADD 0
execute as @s run scoreboard players set @s LuckADD 0
execute as @s run scoreboard players set @s WisdomADD 0
#This adds players stats from adder scores