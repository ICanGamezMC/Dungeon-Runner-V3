...
execute at @e[tag=Level2] if entity @a[distance=..10] if entity @e[tag=L1] if entity @a[sort=nearest,scores={Level=3..}] run particle dust{color:[0.12,1.0,0.0],scale:1} ~ ~ ~ 0 0 0 0 1