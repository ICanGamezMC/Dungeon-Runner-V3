...
function dgen:generation/base_gen/clear
...
function dgen:generation/base_gen/v1/world_boarder
function dgen:generation/base_gen/v1/set_spawn_room
#This is a two step function so rooms only go out 2 other rooms, nothing more
function dgen:generation/base_gen/v1/step
function dgen:generation/base_gen/v1/step
...
function dgen:generation/base_gen/v1/end_step
