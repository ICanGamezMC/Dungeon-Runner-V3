execute as @e[tag=north] store result score @s RNG1 run random value 1..2
execute as @e[tag=south] store result score @s RNG1 run random value 1..2
execute as @e[tag=east] store result score @s RNG1 run random value 1..2
execute as @e[tag=west] store result score @s RNG1 run random value 1..2
