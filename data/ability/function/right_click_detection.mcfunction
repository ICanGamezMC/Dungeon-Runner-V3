...
execute if items entity @s[tag=In_Dungeon] weapon.mainhand *[minecraft:custom_data~{Ability:5b}] if entity @s[scores={Cooldown=..0,Mana=8..}] run function ability:right_click/fire_ball
