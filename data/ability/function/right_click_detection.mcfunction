...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{Ability:7b}] if entity @s[scores={Cooldown=..0,Mana=13..}] run function ability:right_click/pumpkin_blast
