...
execute as @e[tag=north] at @s run function dungeongen:generation/base_gen/v1/place_room/north
execute as @e[tag=south] at @s run function dungeongen:generation/base_gen/v1/place_room/south
execute as @e[tag=east] at @s run function dungeongen:generation/base_gen/v1/place_room/east
execute as @e[tag=west] at @s run function dungeongen:generation/base_gen/v1/place_room/west
